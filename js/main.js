...
(function () {
  ...
  function initMobileMenu() {
    ...
    toggle.addEventListener('click', function () {
      ...
      document.body.style.overflow =
        menu.classList.contains('navbar__menu--open') ? 'hidden' : '';
    });
  ...
  function initSwipers() {
    ...
    // ---- Properties Slider ----
    // Homiva "Our Latest Properties" style: 3-up grid feel with pagination
      ...
      function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            ...
            if (el.classList.contains('reveal-children')) el.classList.add('reveal-children--visible');
    ...
    tabs.forEach(function (tab) {
      tab.addEventListener('click', function () {
        tabs.forEach(function (t) {
          t.classList.remove('properties__tab--active');
        });
